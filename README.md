...
Clone the application and upstream synthetic dataset into the same directory:

```bash
git clone https://github.com/prashanth-ds-ml/diagnostic-tat-early-warning.git
git clone https://github.com/nallamotu/yashoda-synthetic-buildlab.git
...
The default data path expects `yashoda-synthetic-buildlab` beside this
repository. For another location:
